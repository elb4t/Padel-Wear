...
public class AdaptadorGridPager extends FragmentGridPagerAdapter {
    ...
    private final String c[][] = {
            {"6-2 6-7", "6-2, 65% puntos ganados, 81% al servicio",
                    "22 min. 623 pasos, 33º", "6-7, 48% puntos ganados, 64% al servicio", "36 min. 923 pasos, 32º"},
    ...
    @Override public Fragment getFragment(int fila, int col) { int icono = R.drawable.pasos;
        if ((col==0) || ((col-1)%2==0)){
